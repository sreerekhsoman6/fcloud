...
#################################################################################################
#																								#
# FILECLOUD COMMUNITY EDITION LINUX INSTALLATION SCRIPT											#
#																								#
# Written by Nandakumar ( nandakumar@codelathe.com )							                #
# 14/02/2022
#																								#
...
cd
  service httpd restart 3> 3>&2 2>&1 1>&3 3>&-
	service httpd status 2>&1 | write_log
	service fcorchestrator restart 3> 3>&2 2>&1 1>&3 3>&-
	service fcorchestrator status 2>&1 | write_log
	if ! [ -x "$(command -v mongo)" ]; then
  echo 'MongoDB is not installed.' 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
  else
	service mongod restart 3> 3>&2 2>&1 1>&3 3>&-
	service mongod status 2>&1 | write_log
  fi
	service crond restart 3> 3>&2 2>&1 1>&3 3>&-
...
echo "Restarting Services..." 2>&1 | write_log
    cd
    service apache2 restart 3> 3>&2 2>&1 1>&3 3>&-
    ...
    echo 'MongoDB is not installed.' 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
	  ...
	  service mongod status 2>&1 | write_log
		...
		service cron restart 3> 3>&2 2>&1 1>&3 3>&-
...
sudo curl --location $BINARY_URL -o /usr/bin/filecloudcp > 3>&2 2>&1 1>&3 3>&-
...
echo "solr hard nofile 65535" >> /etc/security/limits.conf  > 3>&2 2>&1 1>&3 3>&-
echo "solr soft nofile 65535" >> /etc/security/limits.conf  > 3>&2 2>&1 1>&3 3>&-
echo "solr soft nproc 65535" >> /etc/security/limits.conf > 3>&2 2>&1 1>&3 3>&-
echo "solr hard nproc 65535" >> /etc/security/limits.conf  > 3>&2 2>&1 1>&3 3>&-
sudo mkdir -p /opt/solrfcdata/var/solr/data/fccore | write_log > 3>&2 2>&1 1>&3 3>&-
sudo rsync -r /var/www/html/thirdparty/solarium/fcskel/ /opt/solrfcdata/var/solr/data/fccore/  | write_log > 3>&2 2>&1 1>&3 3>&-
sudo chown solr.solr /opt/solrfcdata/var/solr/data/fccore -Rf | write_log > 3>&2 2>&1 1>&3 3>&-
cd   > 3>&2 2>&1 1>&3 3>&-
rm -rvf $FC_UPGRADE_PATH/tmp/solrinstall | write_log > 3>&2 2>&1 1>&3 3>&-
echo 'Solr Download directory is cleaned' | write_log > 3>&2 2>&1 1>&3 3>&-
...
if [[ -n "$(command -v yum)" ]]; then
 echo "*/5 * * * * php /var/www/html/src/Scripts/cron.php"  | crontab -u apache - 2>3>&2 2>&1 1>&3 3>&-
 crontab -u apache -l
fi

if [[ -n "$(command -v apt-get)" ]]; then
echo "*/5 * * * * php /var/www/html/src/Scripts/cron.php" | crontab -u www-data -  2>3>&2 2>&1 1>&3 3>&-
...
echo -e "\n### Adding PHP repository ###############\n" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
sudo DEBIAN_FRONTEND=noninteractive apt-get update -y -o Dpkg::Options::="--force-confdef" -o Dpkg::Options::="--force-confold"
sudo apt-get install software-properties-common -y
sudo apt-get install language-pack-en -y
LC_ALL=C.UTF-8 sudo add-apt-repository ppa:ondrej/php -y 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
LC_ALL=C.UTF-8 add-apt-repository ppa:ondrej/apache2 -y  2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-

### Install Webserver ###################################

echo -e "\n### Installing apache #############\n" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
sudo apt-get update -y 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
sudo apt-get install unzip curl rsync python  -y  2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
...
sudo service apache2 restart 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-

set +e
echo "* Switching CLI PHP to 7.4..." 2>&1 | write_log
sudo update-alternatives --set php /usr/bin/php7.4 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
sudo update-alternatives --set phar /usr/bin/phar7.4 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
sudo update-alternatives --set phar.phar /usr/bin/phar.phar7.4 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
sudo update-alternatives --set phpize /usr/bin/phpize7.4 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
sudo update-alternatives --set php-config /usr/bin/php-config7.4 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
...
echo -e "" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
echo -e "###############################" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
echo -e "### VERIFY THE OUTPUT BELOW ###" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
echo -e "###############################" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
echo -e "\n### PHP ###############\n" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
echo -e "$(php -v)" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-

rm -rvf ${FC_INSTALL_DIR}/ioncubeinstall 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
...
sudo apt-get install software-properties-common -y
wget -q https://packages.sury.org/php/apt.gpg -O- | sudo apt-key add - 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
...
echo -e "\n### COPYING IONCUBE ##\n" 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
cp -rvf ${FC_INSTALL_DIR}/ioncubeinstall/ioncube /usr/lib/php/7.4/ 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
echo "zend_extension = '/usr/lib/php/7.4/ioncube/ioncube_loader_lin_7.4.so'" > /etc/php/7.4/mods-available/01-ioncube.ini 2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
ln -sfn /etc/php/7.4/mods-available/01-ioncube.ini /etc/php/7.4/apache2/conf.d/  2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
ln -sfn /etc/php/7.4/mods-available/01-ioncube.ini /etc/php/7.4/cli/conf.d/  2>&1 | write_log > 3>&2 2>&1 1>&3 3>&-
